          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
            ...
            <div className="space-y-4 max-w-md">
              ...
              <p className="text-primary-foreground/80 text-sm">
                ...
                адаптированные под вашу сферу: TV, реклама, медиа и онлайн-сервисы,<br />
                медклиники, wellness, отели и SPA... Контент сопровождается всеми<br />
                авторскими правами и лицензиями. Готовое решение экономит время<br />
                и даёт Вашему бизнесу новую ценность!
              </p>
            </div>
