          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
            ...
            <div className="space-y-4 max-w-md">
              ...
              <p className="text-primary-foreground/80 text-sm">
                ...
                адаптированные под вашу сферу: TV, медиа и онлайн-сервисы,<br />
                медклиники, отели и SPA, wellness, реклама и digital signage.<br />
                Контент сопровождается всеми авторскими правами и лицензиями.<br />
                Готовое решение экономит время и даёт Вашему бизнесу новую ценность!
              </p>
            </div>
